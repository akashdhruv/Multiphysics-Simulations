...
#--------------I${subst :, -I,$(CPATH)}--------------------------------------------------------------
FCOMP   = $(HDF5_PATH)/bin/h5pfc -Wl,-ld64
...
FFLAGS_OPT   = -c -O2 -fdefault-real-8 -fdefault-double-8 -Wuninitialized \
	       -fallow-argument-mismatch -Wno-error=int-conversion
...
#-------------------------------------------------------------------------------
CFLAGS_OPT   = -c -O2 -Wuninitialized -D_FORTIFY_SOURCE=2 -Wno-error=int-conversion
...
CFLAGS_DEBUG = -ggdb -c -O0 -Wno-div-by-zero -Wundef \
	       ...
	       -Wunsafe-loop-optimizations -Wpadded -fstack-protector-all -Wno-error=int-conversion
